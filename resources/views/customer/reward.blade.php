    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            ...
            <div class="text-center mb-4">
                <h1 class="display-6 fw-bold mb-2" style="color: #dc3545;">Stamp Rewards Program</h1>
                <p style="color: #8A8584;">Collect stamps with every 7-hour booking and earn exclusive discounts!</p>
            </div>

            <!-- Current Stamp Card -->
            <div class="card shadow-lg border-0 mb-4" style="background: linear-gradient(135deg, #fff5f5 0%, #ffffff 100%);">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 class="mb-0" style="color: #dc3545;">Your Stamp Card</h3>
                        <span class="badge px-4 py-2" style="background: #dc3545; font-size: 1.1rem;">
                            ...
                            <div class="col-4 col-sm-3 col-md-2">
                                <div class="stamp-wrapper text-center">
                                    @if ($i <= ($currentStamps ?? 0))
                                        ...
                                        <div class="stamp-number mt-2">{{ $i }}</div>
                                    @else
                                        <!-- Empty Stamp -->
                                        ...
                                        <div class="stamp-number-empty mt-2">{{ $i }}</div>
                                    @endif
                    ...
                    <!-- Progress Bar -->
                    <div class="progress mb-3" style="height: 30px; background: #ffe0e6;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated" 
                             style="background: linear-gradient(90deg, #dc3545 0%, #c82333 100%);"
                             role="progressbar" 
                             style="width: {{ (($currentStamps ?? 0) / 12) * 100 }}%")
                    ...
                    @if (($currentStamps ?? 0) >= 12)
                        <div class="alert text-center" style="background: #d4edda; border: 2px solid #28a745; color: #155724;" role="alert">
                            <h5 class="alert-heading">🎉 Congratulations!</h5>
                            <p class="mb-0">You've completed your stamp card! Redeem your 50% discount on your next booking.</p>
                        </div>
                    @elseif (($currentStamps ?? 0) >= 9)
                        <div class="alert text-center" style="background: #fff3cd; border: 2px solid #ffc107; color: #856404;" role="alert">
                            <h5 class="alert-heading">🌟 Almost There!</h5>
                            <p class="mb-0">You've unlocked 30% discount! {{ 12 - ($currentStamps ?? 0) }} more stamps to get 50% discount.</p>
                        </div>
                    @elseif (($currentStamps ?? 0) >= 3)
                        <div class="alert text-center" style="background: #d1ecf1; border: 2px solid #17a2b8; color: #0c5460;" role="alert">
                            <h5 class="alert-heading">✨ Congratulations!</h5>
                            <p class="mb-0">You've unlocked 20% discount! {{ 9 - ($currentStamps ?? 0) }} more stamps to get 30% discount.</p>
                        </div>
                    @else
                        <p class="text-center mb-0" style="color: #dc3545; font-weight: 500;">
            ...
            <div class="card shadow-lg border-0 mb-4">
                <div class="card-body p-4">
                    <h3 class="mb-4" style="color: #dc3545;">Discount Rewards</h3>
                    <div class="row g-3">
                        <!-- Tier 1: 3 Stamps = 20% -->
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="reward-card {{ ($currentStamps ?? 0) >= 9 ? 'unlocked' : 'locked' }}">
                                ...
                                <h4 class="reward-title">30% Discount</h4>
                        ...
                        <div class="col-md-4">
                            <div class="reward-card {{ ($currentStamps ?? 0) >= 12 ? 'unlocked' : 'locked' }} premium">
                                ...
                                <h4 class="reward-title">50% Discount</h4>
            ...
            <div class="card shadow-lg border-0">
                <div class="card-body p-4">
                    <h3 class="mb-4" style="color: #dc3545;">Stamp History</h3>
                            ...
                            <tbody>
                                @forelse ($stampHistory ?? [] as $history)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge px-3 py-2" style="background: #dc3545;">
            ...
            <div class="card shadow-lg border-0 mt-4" style="background: linear-gradient(135deg, #fff5f5 0%, #ffe0e6 100%);">
                <div class="card-body p-4">
                    <h3 class="mb-4 text-center" style="color: #dc3545;">How It Works</h3>
                    <div class="row text-center">
                        <div class="col-md-3 mb-3">
                            <div class="how-icon">⏰</div>
                            <h5>Book 7 Hours</h5>
                            <p class="small text-muted">Each 7-hour booking counts</p>
                        </div>
                        <div class="col-md-3 mb-3">
                            <div class="how-icon">🔴</div>
                            <h5>Earn 1 Stamp</h5>
                            <p class="small text-muted">A red stamp is added</p>
                        </div>
                        <div class="col-md-3 mb-3">
                            <div class="how-icon">📊</div>
                            <h5>Collect Stamps</h5>
                            <p class="small text-muted">3, 9, or 12 stamps</p>
                        </div>
                        <div class="col-md-3 mb-3">
                            <div class="how-icon">🎁</div>
                            <h5>Get Discounts</h5>
                            <p class="small text-muted">20%, 30%, or 50%</p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Keep the existing styles as-is -->
<style>
/* Stamp Wrapper */
.stamp-wrapper {
    position: relative;
